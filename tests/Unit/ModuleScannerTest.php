...
final class ModuleScannerTest extends TestCase
{
    ...
    {
        mkdir($this->tmpDir . '/modules', 0o755, true);
    ...
    {
        mkdir($this->tmpDir . '/modules/Shop', 0o755, true);
    ...
    {
        mkdir($this->tmpDir . '/modules/Broken', 0o755, true);
    ...
    {
        mkdir($this->tmpDir . '/modules/Weird', 0o755, true);
        file_put_contents(
